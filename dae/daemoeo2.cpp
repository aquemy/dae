...
int main (int argc, char *argv[])
{
 	...
 	eoState state;                                  // to keep all things allocated
  	...
  	// General parameters
  	daex::make_general_param(parser, state);        // Common part
  	//daex::make_general_param_moeo(parser, state);   // Multiobjectives part
    ...
    daex::Init<Planning> & init = do_make_genotype<Planning>(parser, state, pddl); 	
