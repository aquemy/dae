...
if ("${Paradiseo_FIND_COMPONENTS}" STREQUAL "")
    set(PARADISEO_LIBRARIES_TO_FIND eo edo eoutils cma es flowshop ga moeo)
else()
...
foreach(FIND_PARADISEO_COMPONENT ${PARADISEO_LIBRARIES_TO_FIND})
    ...
    message("${FIND_PARADISEO_COMPONENT} found : ${PARADISEO_${FIND_PARADISEO_COMPONENT_UPPER}_LIBRARY}")
    if (PARADISEO_${FIND_PARADISEO_COMPONENT_UPPER}_LIBRARY OR ${FIND_PARADISEO_COMPONENT} STREQUAL "mo" OR ${FIND_PARADISEO_COMPONENT} STREQUAL "edo")
        # library found
