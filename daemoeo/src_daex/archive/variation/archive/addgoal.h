...
class MutationAddGoal: public eoMonOp<MOEOT>
{
public:
    MutationAddGoal(
    ...
    Goal random_goal(  TimeVal t1, TimeVal t2 ) 
{
    ...
    //! Maximal size of a EOT
    /** If the EOT is already at the max size, the mutation don't add any new goal
     */
    //unsigned int _l_max;
};
