...
public:
    ...
    void load_pddl( std::string solver = SOLVER_YAHSP, unsigned int heuristic_start_times = HEURISTIC_H1, unsigned int nthreads = 1, std::vector<std::string> solver_args = std::vector<std::string>());
