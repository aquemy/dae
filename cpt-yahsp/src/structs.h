...
#define get_distance(a1, a2) ((a1)->distances[(a2)->origin->id])
#define store_distance(a1, a2, d) store((a1)->distances[(a2)->num], d)

#define distance_ca(c, a) get_distance((c)->consumer, a)
#define distance_ac(a, c) ({TimeVal _d = MAXCOST; FORPROD(_a2, c) { minimize(_d, get_distance(a, _a2)); } EFOR; _d; })
...
#define delta_aa(a1, a2) (duration(a1) + get_distance(a1,a2))
